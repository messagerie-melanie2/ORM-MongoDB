...
/**
 * Objet Property pour les API PHP
 *
 * @property string $name Nom de la propriété
 * @property string $value Valeur de la propriété
 * @property array $params Paramètres pour la propriété
 */
class Property extends \ORM\Core\Mapping\ObjectMapping {
  /**
